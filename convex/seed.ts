...
export const seedMarkets = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    const markets = [
      // ─── Gemini UX 2.0 — monthly bets ───
      {
        title: "Gemini UX 2.0 Update this month?",
        description: "Will Google release the Gemini UX 2.0 major interface update during March 2026?",
        category: "Google",
        endDate: new Date("2026-03-31").getTime(),
      },
      {
        title: "Gemini UX 2.0 Update in April?",
        description: "Will Google release the Gemini UX 2.0 major interface update during April 2026?",
        category: "Google",
        endDate: new Date("2026-04-30").getTime(),
      },
      {
        title: "Gemini UX 2.0 Update in May?",
        description: "Will Google release the Gemini UX 2.0 major interface update during May 2026?",
        category: "Google",
        endDate: new Date("2026-05-31").getTime(),
      },
      {
        title: "Gemini UX 2.0 Update in June?",
        description: "Will Google release the Gemini UX 2.0 major interface update during June 2026?",
        category: "Google",
        endDate: new Date("2026-06-30").getTime(),
      },
      {
        title: "Gemini UX 2.0 Update in Q3 2026?",
        description: "Will Google release the Gemini UX 2.0 major interface update during Q3 (Jul-Sep) 2026?",
        category: "Google",
        endDate: new Date("2026-09-30").getTime(),
      },
      {
        title: "Gemini UX 2.0 — Not this year?",
        description: "Will Google fail to release the Gemini UX 2.0 update during 2026? Resolves YES if no release by Dec 31.",
        category: "Google",
        endDate: new Date("2026-12-31").getTime(),
      },

      // ─── DeepSeek v4 — day / week / month bets ───
      {
        title: "DeepSeek v4 announced today?",
        description: "Will DeepSeek announce or release v4 today (March 12, 2026)?",
        category: "DeepSeek",
        endDate: new Date("2026-03-13").getTime(),
      },
      {
        title: "DeepSeek v4 released this week?",
        description: "Will DeepSeek release v4 during the week of March 10-16, 2026?",
        category: "DeepSeek",
        endDate: new Date("2026-03-16").getTime(),
      },
      {
        title: "DeepSeek v4 released this month?",
        description: "Will DeepSeek release v4 during March 2026?",
        category: "DeepSeek",
        endDate: new Date("2026-03-31").getTime(),
      },

      // ─── Other AI model markets ───
      {
